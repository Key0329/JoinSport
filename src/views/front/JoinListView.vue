...
export default {
  ...
  data() {
    return {
      listTypes: [
        { label: '熱門', icon: 'pi pi-fw pi-hot', to: '/JoinList/JoinListHot' },
        { label: '最新', icon: 'pi pi-fw pi-new', to: '/JoinList/JoinListNew' },
      ],
      selectedTime: null,
      selectedType: null,
...
<template>
  ...
  <section class="top-0 z-20 bg-white pt-[75px] sm:sticky">
    <div class="container">
      <div
        class="mt-5 flex w-full flex-col items-center justify-between border-b py-5 md:my-0 md:flex-row lg:py-0"
      >
        <!-- list type -->
        <TabMenu :model="listTypes" class="mb-6 text-3xl md:mb-0" />
        <!-- tags -->
